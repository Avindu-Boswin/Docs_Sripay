        ...
        <div className='w-full px-4 sm:px-6 md:px-10 lg:px-[12%] mt-8 mb-16'>
            ...
            <div className='py-10 space-y-3 text-sm sm:text-base text-gray-700 leading-relaxed'>
                ...
                <div>
                    ...
                    <h3 className='mt-10 text-xl xl:text-base'>SriPay Sub-Acquirer support</h3>
                    <ul className='px-7'>
                        <li className='py-2'>
                            Address:{' '}
                ...
                <div>
                    ...
                    <h3 className='mt-10 text-xl xl:text-base'>SriPay Merchant Sub-Acquirer support</h3>
                    <ul className='px-7'>
                        <li className='py-2'>
                            Mobile:{' '}
                    ...
                    <h3 className='mt-10 text-xl xl:text-base'>SriPay Sub-Acquirer Technical support</h3>
                    <ul className='px-7'>
                        <li className='py-2'>
                            Mobile:{' '}
