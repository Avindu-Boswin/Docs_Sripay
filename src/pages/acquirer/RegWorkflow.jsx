    ...
    <div className='w-full px-4 sm:px-8 md:px-16 lg:px-[12%] mt-10'>
      ...
      <div id="step3" className='mt-8 mb-6'>
        ...
        <ul className='list-disc text-gray-700 ml-6 sm:ml-8 mb-4 mt-5 text-sm'>
          {/* first feature with nested columns list */}
          <li className='mb-2 font-semibold text-gray-600'>{steps[2].features[0]}</li>
          ...
          {/* second feature */}
          <li className='mb-2 mt-3 font-semibold text-gray-600'>{steps[2].features[1]}</li>
          <ul className='list-disc ml-6 sm:ml-8'>
            <li>Complete KYC</li>
          </ul>
        </ul>
