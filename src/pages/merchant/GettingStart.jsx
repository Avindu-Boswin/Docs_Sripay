...
function GettingStart() {
  ...
  return (
    ...
    <span className='text-base sm:text-lg md:text-xl text-gray-600'>To become a Merchant  in the <span className='text-blue-600 font-bold'>SriPay</span>{t('acquirerGettingStart.intro2')}</span>
    ...
    <div className='mt-8 mb-6'>
        ...
        <div className='ml-1 sm:ml-3 mt-7'>
            <span className='font-semibold text-gray-600'>{t('acquirerGettingStart.step1EmailDesc')}</span> <span className='ml-2 text-sm text-gray-600'>Request to Create Merchant Account</span>
            <div className='mt-5'>
                ...
                <ul className='list-disc text-gray-700 ml-6 sm:ml-8 mt-4 text-sm'>
                    ...
                    <li className='p-1.5'>A brief statement requesting access to create a Merchant account on SriPay</li>
                </ul>
            </div>
        </div>
    </div>
