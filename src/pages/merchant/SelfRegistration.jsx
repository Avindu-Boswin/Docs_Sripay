...
function SelfRegistration() {
  ...
  return (
    ...
    <div className='mb-8'>
        ...
        <div className='mb-2'>To activate this feature, you must send a formal request to SriPay to enable Merchant Self Sign-Up for your Merchant account.</div>
        ...
        <div className='ml-2'>
            <ul className='list-disc ml-6 text-gray-700 text-sm'>
                ...
                <li>Your Merchant Name and ID</li>
