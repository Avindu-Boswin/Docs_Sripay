    ...
    <div className='w-full px-4 sm:px-8 md:px-16 lg:px-[12%] mt-10'>
      ...
      <div className='mt-8 mb-6'>
        ...
        <p className='text-gray-700 text-base leading-relaxed mb-4'>
          The SriPay Connect Merchant API follows a structured request URL format, which is composed of two distinct parts
        </p>
        ...
        <ul className='list-disc pl-6 mb-4 text-gray-800'>
          <li><span className='font-semibold'>Host</span> – The base URL of the SriPay Connect Merchant API environment you are connecting to.</li>
        ...
        <p className='text-gray-700 text-base leading-relaxed mb-4'>
          SriPay Connect Merchant APIs support only two HTTPS request methods
        </p>
        <div className='mb-4'>
        ...
        <p className='text-gray-700 text-base leading-relaxed mb-4'>
          All SriPay Connect Merchant API requests must include the following headers to ensure proper authentication and routing:
        </p>
        <div className='mb-6 overflow-x-clip' style={{ maxWidth: '100%' }}>
          <Table
            ...
            dataSource={[
              ...
              {
                key: '2',
                headerName: <><span className='font-semibold'>MerchantId</span> or<br /><span className='font-semibold'>x-mch-id</span></>,
                description: 'Unique identifier assigned to each merchant for request routing and access control.',
