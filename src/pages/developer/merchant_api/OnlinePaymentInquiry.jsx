...
function MerchantOnlinePaymentInquiry() {
    ...
    return (
        <div className='w-full px-4 sm:px-8 md:px-16 lg:px-[12%] mt-10'>
            ...
            <p className='text-gray-700 text-base leading-relaxed mb-8'>This endpoint retrieves detailed information about payment and refund transactions associated with a specific paymentRequestId for a given merchant, sorting results by timestamp in descending order.</p>
