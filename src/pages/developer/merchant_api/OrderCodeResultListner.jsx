...
function MerchantOrderCodeResultListner() {
            ...
            <div id='step-7' className="mt-12 mb-8">
                ...
                <div>
                    ...
                    <ul className='list-disc pl-6 mb-4 space-y-2'>
                        <li>The endpoint uses SSE to maintain a persistent connection, streaming updates
                            from the Alipay+ Instore Transactions.</li>
                        <li>Timestamps (gmt_payment) are converted from GMT+8 to Asia/Colombo
                            (GMT+5:30). </li>
                        <li> A heartbeat message (:\n\n) is sent every 30 seconds to keep the connection
                            alive.</li>
                        <li>The connection closes automatically when a transaction update is received or an
                            error occurs, and it cleans up resources on client disconnect.
                        </li>
                    </ul>
                </div>
            </div>
