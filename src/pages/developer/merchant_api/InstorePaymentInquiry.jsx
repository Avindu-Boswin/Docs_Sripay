...
function MerchantInstorePaymentInquiry() {
    ...
    useEffect(() => {
        setSections([
            { id: 'step-1', label: 'instore payment inquiry' },
    ...
    return (
        <div className='w-full px-4 sm:px-8 md:px-16 lg:px-[12%] mt-10'>
            ...
            <p className='text-gray-700 text-base leading-relaxed mb-8'>This endpoint retrieves detailed information about transactions and refunds associated with a specific transactionId (trade_no) for a given merchant, sorting results by timestamp in descending order.</p>
            ...
            <div className='mt-8 mb-6'>
                ...
                <ul className='list-disc pl-6 mb-4 text-gray-800 space-y-2'>
                    ...
                    <li><span className='font-semibold'>Description</span> – Fetches transaction and refund records based on transactionId.</li>
                </ul>
